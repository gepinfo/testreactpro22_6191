...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_testreactpro22_6191;
            let db_auth = result.data.DB_AUTH_testreactpro22_6191;
            let db_coll = result.data.DB_COLL_testreactpro22_6191;
